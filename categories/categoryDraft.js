  ...
  properties: {
    ...
    slug: {
      ...
      description:
        ...
        Must match the pattern [-a-zA-Z0-9_]{2,256} human-readable identifiers \
        usually used as deep-link URL to the related category. Each slug is \
        unique across a project, but a category can have the same slug for \
        different languages."
    },
    orderHint: {
      type: "string",
