...
module.exports = {
  ...
  properties: {
    customerNumber: {
      type: "string",
      description:
        "String that uniquely identifies a customer. It can be used to create \
        more human-readable (in contrast to ID) identifier for the customer. \
        It should be unique across a project. Once it’s set it cannot be \
        changed."
    },
    email: {
      type: "string",
      description:
        "Stored in given case. For the uniqueness check, it is treated as \
        case-insensitive.",
      format: "email"
    },
    key,
    ...
    anonymousCartId: {
      type: "string",
      description:
        "Identifies a single cart that will be assigned to the new customer \
        account."
    },
    anonymousId: {
      type: "string",
      description:
        "Identifies carts and orders belonging to an anonymous session that \
        will be assigned to the new customer account."
    },
    ...
    defaultBillingAddress: {
      ...
      description:
        ...
        The defaultBillingAddressId of the customer will be set to the ID of \
        that address."
    },
    billingAddresses: {
      type: "array",
      description:
        ...
        The billingAddressIds of the customer will be set to the IDs of that \
        addresses.",
      items: { type: "number" }
    },
    defaultShippingAddress: {
      ...
      description:
        "The index of the address in the addresses array. \
        The defaultShippingAddressId of the customer will be set to the ID of \
        that address."
    },
    shippingAddresses: {
      type: "array",
      description:
        ...
        The shippingAddressIds of the Customer will be set to the IDs of that \
        addresses.",
      items: { type: "number" }
    },
